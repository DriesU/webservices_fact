...
const likedFactsService = require('../service/place');
...
module.exports = (app) => {
  ...
  router.get('/', validate(getAllLikedFacts.validationScheme), getAllLikedFacts);
  router.get('/:userId', validate(findAllFromUserWithFact.validationScheme), findAllFromUserWithFact);
  router.get('/:userId/:categoryId', validate(findAllFromUserWithFactAndCategory.validationScheme), findAllFromUserWithFactAndCategory);
  ...
  router.delete('/:userId/:factId', validate(deleteById.validationScheme), deleteById);
